    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(98.0, 123.0),
            child:
                // Adobe XD layer: 'Jupiter_(transparen…' (shape)
                Container(
              width: 180.0,
              height: 178.0,
              decoration: BoxDecoration(
