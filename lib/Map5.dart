      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.1, 56.0, 529.0, 309.0),
                    size: Size(898.1, 1047.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Container(),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 463.8, 376.1, 273.6),
                    size: Size(898.1, 1047.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(105.1, 488.0, 170.0, 34.0),
                    size: Size(898.1, 1047.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'Estimated Walk Time: 15 min\nEstimated Drive Time : 4 Min',
                      style: TextStyle(
                        fontFamily: 'Gibson',
                        fontSize: 14,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(164.1, 551.0, 52.0, 55.0),
                    size: Size(898.1, 1047.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 52.0, 22.0),
                          size: Size(52.0, 55.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(4.0, 37.0, 44.0, 18.0),
                          size: Size(52.0, 55.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(18.1, 645.0, 342.0, 66.0),
                    size: Size(898.1, 1047.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(158.1, 669.0, 80.0, 15.0),
                    size: Size(898.1, 1047.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(241.1, 546.0, 65.0, 65.0),
                    size: Size(898.1, 1047.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Container(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(255.1, 564.0, 38.0, 30.0),
                    size: Size(898.1, 1047.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: '01ec0e5e8e5af3ff4b5…' (shape)
                Container(
              width: 34.0,
              height: 34.0,
              decoration: BoxDecoration(
...
const String _svg_k8jns3 =
    '<svg viewBox="-2.1 463.8 376.1 273.6" ><path transform="translate(-2.06, 463.77)" d="M 12.03575801849365 0 L 364.0817260742188 0 C 370.7288818359375 0 376.1174621582031 6.533835887908936 376.1174621582031 14.5937328338623 L 376.1174621582031 273.6324768066406 L 0 273.6324768066406 L 0 14.5937328338623 C 0 6.533835887908936 5.388592720031738 0 12.03575801849365 0 Z" fill="#1e344e" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
